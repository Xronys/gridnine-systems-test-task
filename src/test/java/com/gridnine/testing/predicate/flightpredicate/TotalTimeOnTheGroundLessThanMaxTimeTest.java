...
public class TotalTimeOnTheGroundLessThanMaxTimeTest {
    private TotalTimeOnTheGroundLessThanMaxTime totalTimeOnTheGroundLessThanMaxTime =
    ...
    public static Object[][] data() {
        ...
        segments2.add(new Segment( LocalDateTime.now().plusHours(12), LocalDateTime.now().plusHours(15)));
    ...
    public void testTest( Flight flight, boolean result ) {
        Assert.assertEquals(result, totalTimeOnTheGroundLessThanMaxTime.test(flight));
    }
}
